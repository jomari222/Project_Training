                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="" method="POST" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="text-center" id="font_green">Update Address</h2>
                                    <hr>
                                </div>
                            </div>
                            <div class="form-group">
