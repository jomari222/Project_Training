...
$(document).ready(function()
{
    ...
    $('#table_Users_wrapper .dataTables_filter').find('input').each(function ()
    {
        const $this = $(this);
        $this.addClass('form-control-sm');
    });
    $('#table_Users_wrapper .dataTables_filter').find('label').each(function ()
    {
        const $this = $(this);
        $this.attr("id", "lblSearch_Transactions");
    });
    $('#table_Users_wrapper .dataTables_length').find('label').each(function ()
    {
        const $this = $(this);
        $this.attr("id", "lblShow_Transactions");
    });
    $('#table_Users_wrapper .dataTables_length').find('select').each(function ()
    {
        const $this = $(this);
        $this.attr("id", "slcEntries_Transactions");
        $this.addClass('btn btn-dark');
