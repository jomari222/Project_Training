            ...
            <div class="card" id="bg-green">
                ...
                <div class="card-body" id="card_body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h3 class="" id="font_green">Account</h3>
                            <hr>
                            <div class="form-group">
                            ...
                            <label id="">Position:
                                <select id="slc_position" name="select_position" class="btn btn-success dropdown-toggle form-control" required>
                ...
                <div class="card-footer" id="card_footer">
                    <button class="btn btn-block btn-success" type="submit" id="btnInsert_User" name="buttonInsert_User">Add User</button>
                </div>
            </div>
        </form>
    </div>
