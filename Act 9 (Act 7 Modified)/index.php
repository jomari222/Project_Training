...
<div id="dvLogin">
    <form id="frmLogin" action="includes/login.php" method="POST">
        ...
        <input type="text" id="txtUsername" name="fUsername" placeholder="Enter Username" maxlength="20" value="" required/>
        <p id="lblPassword">Password: </p>
        <input type="password" id="txtPassword" name="fPassword" placeholder="Enter Password" maxlength="60" required/>
        <br>
