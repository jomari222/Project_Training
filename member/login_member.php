...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="container-md p-5 text-white" id="dvLogin">
            <form id="frmLogin" action="includes/login.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="txtPhone_number" name="fPhone_number" placeholder="Enter Username or Phone number" maxlength="60" value="" required/>
            ...
            <span id="" onclick=""><a href="registration.php">Register</a> now!</span>
        </div>
    </div>
    <div class="col-md-4"></div>
</div>
